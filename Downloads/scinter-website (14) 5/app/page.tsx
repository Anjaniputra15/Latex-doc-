  ...
  return (
    <main className="min-h-screen text-white relative overflow-hidden bg-gradient-to-b from-black via-purple-900/20 to-black">
      ...
      >
        ...
        <motion.p
          className="text-sm sm:text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-[2] text-center mb-8"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      <section id="about" className="relative py-16 md:py-24 px-4">
        <motion.div
          className="text-center w-full max-w-5xl mx-auto backdrop-blur-xl bg-white/5 rounded-xl p-8 sm:p-12 border border-white/10"
      ...
      <section id="features" className="relative py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            <span className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl shadow-lg backdrop-blur-sm bg-opacity-80 text-shadow">Key Features</span>
          </h2>
      ...
      <section id="how-it-works" className="relative py-16 md:py-24 px-4">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            <span className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl shadow-lg backdrop-blur-sm bg-opacity-80 text-shadow">How It Works?</span>
          </h2>
      ...
      <section id="knowledge-graph" className="relative py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            <span className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl shadow-lg backdrop-blur-sm bg-opacity-80 text-shadow">Interactive Knowledge Graph</span>
          </h2>
      ...
      <section id="use-cases" className="relative py-16 md:py-24 px-4">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold mb-12 text-center">
            <span className="bg-gradient-to-r from-purple-600 to-blue-600 text-white px-6 py-3 rounded-xl shadow-lg backdrop-blur-sm bg-opacity-80 text-shadow">Use Cases</span>
          </h2>
          <UseCases />
        </div>
      </section>
      ...
      <section id="join" className="relative py-16 md:py-24 px-4 bg-gradient-to-b from-black to-purple-900/30">
        <motion.div
          className="max-w-5xl mx-auto text-center backdrop-blur-xl bg-white/5 rounded-xl p-8 sm:p-12 border border-white/10"
          initial={{ opacity: 0, y: 50 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          viewport={{ once: true, amount: 0.3 }}
        >
          ...
          <Button
            size="lg"
            onClick={() => setIsSubscribeOpen(true)}
            className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-4 text-xl rounded-xl transform transition-all duration-200 hover:scale-105 hover:shadow-lg"
          >
            Subscribe Now
          </Button>
        </motion.div>
...
const FeatureCard: React.FC<FeatureCardProps> = ({ icon: Icon, title, description }) => (
  <motion.div
    className="backdrop-blur-xl bg-white/5 rounded-xl p-6 border border-white/10 transform transition-all duration-300 hover:scale-105 hover:bg-white/10"
    whileHover={{ y: -5 }}
    initial={{ opacity: 0, y: 20 }}
    whileInView={{ opacity: 1, y: 0 }}
    viewport={{ once: true, amount: 0.3 }}
